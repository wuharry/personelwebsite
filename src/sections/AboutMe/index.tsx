...
const AboutMe: FunctionComponent<AboutMeProps> = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'w-full flex-col items-center gap-1 sm:flex sm:flex-row sm:justify-evenly',
          'mt-20 rounded-lg bg-white/5 p-8 shadow-xl backdrop-blur-md sm:mt-14',
          'mx-auto max-w-7xl',
        )}
      >
        ...
        <section className={clsx('flex flex-col justify-between')}>
          <div className={clsx(`${animetion ? `animate-fade-down` : ``}`)}>
            <h1 className={clsx(`mx-0 my-1 text-4xl font-bold text-white`)}>
              我是 吳浩維
            </h1>
            <h3 className={clsx(`text-3xl font-medium text-white`)}>
              我是一名前端工程師
            </h3>
          </div>
